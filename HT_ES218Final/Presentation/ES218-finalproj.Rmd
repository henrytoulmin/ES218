...
```{r Average Temperature per Month, echo=TRUE, fig.align="center"}
dat1 <- dat %>%
  group_by(monthyear) %>% 
...
```{r, Temp residuals, echo=TRUE, fig.height=2.5, fig.align="center"}
...
```{r Average Relative Humidity per Month, echo=TRUE, fig.align="center"}
...
```{r, RH residuals, echo=TRUE, fig.height=2.5, fig.align="center"}
# Check the residual dependance plot
...
```{r Total Rainfall per Year, echo=TRUE, fig.align="center"}
dat2 <- dat %>%
  group_by(year) %>% 
  summarise(avg.temp = mean(temp),
            avg.rh = mean(rh),
...
```{r, RF residuals, echo=TRUE, fig.height=2.5, fig.align="center"}
# Check the residual dependance plot
